...
public class AutoScrollUpVM extends BaseVM {
    public List<AutoScrollUpCM> dataCMList = new ArrayList<>();
        ...
        return new LoadDataUiTask.OnExecute() {
            @Override public void onExecute(LoadDataUiTask task) {
                try {
                    ...
                    for (int i = 0; i < 10; i++) {
                        dataCMList.add(new AutoScrollUpCM(String.format("内容：%d", i)));
                    }
