...
import com.ulfy.master.ui.view.ViewToBitmapViewView;

public class ViewToBitmapViewVM extends BaseVM {
    public String pictureUrl;

    public ViewToBitmapViewVM(String pictureUrl) {
    ...
    @Override public Class<? extends IView> getViewClass() {
        return ViewToBitmapViewView.class;
    }
}