...
import com.ulfy.master.ui.view.SmartTransponderView;


public class SmartTransponderActivity extends TitleContentActivity {
    private SmartTransponderVM vm;
    private SmartTransponderView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(SmartTransponderActivity.class);
    }
    ...
    private void initContent(final Bundle savedInstanceState) {
        TaskUtils.loadData(getContext(), vm.loadDataOnExe(), new ContentDataLoader(contentFL, vm, false) {
                    @Override protected void onCreateView(ContentDataLoader loader, View createdView) {
                        view = (SmartTransponderView) createdView;
                    }
