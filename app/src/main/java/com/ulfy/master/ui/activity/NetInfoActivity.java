...
import com.ulfy.master.ui.view.NetInfoView;

public class NetInfoActivity extends TitleContentActivity {
    private NetInfoVM vm;
    private NetInfoView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(NetInfoActivity.class);
    }
