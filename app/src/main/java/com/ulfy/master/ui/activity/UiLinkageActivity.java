...
import com.ulfy.master.ui.view.UiLinkageView;


public class UiLinkageActivity extends TitleContentActivity {
    private UiLinkageVM vm;
    private UiLinkageView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(UiLinkageActivity.class);
    }
    ...
    private void initContent(final Bundle savedInstanceState) {
        TaskUtils.loadData(getContext(), vm.loadDataOnExe(), new ContentDataLoader(contentFL, vm, false) {
                    @Override protected void onCreatView(ContentDataLoader loader, View createdView) {
                        view = (UiLinkageView) createdView;
                    }
