...
import com.ulfy.master.ui.view.TaskTransponderView;


public class TaskTransponderActivity extends TitleContentActivity {
    private TaskTransponderVM vm;
    private TaskTransponderView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(TaskTransponderActivity.class);
    }
    ...
    private void initContent(final Bundle savedInstanceState) {
        TaskUtils.loadData(getContext(), vm.loadDataOnExe(), new ContentDataLoader(contentFL, vm, false) {
                    @Override protected void onCreatView(ContentDataLoader loader, View createdView) {
                        view = (TaskTransponderView) createdView;
                    }
