...
import com.ulfy.master.ui.view.RatioLayoutView;


public class RatioLayoutActivity extends TitleContentActivity {
    private RatioLayoutVM vm;
    private RatioLayoutView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(RatioLayoutActivity.class);
    }
    ...
    private void initContent(final Bundle savedInstanceState) {
        TaskUtils.loadData(getContext(), vm.loadDataOnExe(), new ContentDataLoader(contentFL, vm, false) {
                    @Override protected void onCreateView(ContentDataLoader loader, View createdView) {
                        view = (RatioLayoutView) createdView;
                    }
