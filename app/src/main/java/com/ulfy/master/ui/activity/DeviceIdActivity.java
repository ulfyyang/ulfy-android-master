...
import com.ulfy.master.ui.view.DeviceIdView;

public class DeviceIdActivity extends TitleContentActivity {
    private DeviceIdVM vm;
    private DeviceIdView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(DeviceIdActivity.class);
    }
