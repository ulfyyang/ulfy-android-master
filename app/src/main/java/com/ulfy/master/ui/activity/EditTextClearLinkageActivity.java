...
import com.ulfy.master.ui.view.EditTextClearLinkageView;

public class EditTextClearLinkageActivity extends TitleContentActivity {
    private EditTextClearLinkageVM vm;
    private EditTextClearLinkageView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(EditTextClearLinkageActivity.class);
    }
    ...
    private void initContent(final Bundle savedInstanceState) {
        TaskUtils.loadData(getContext(), vm.loadDataOnExe(), new ContentDataLoader(contentFL, vm, false) {
                    @Override protected void onCreateView(ContentDataLoader loader, View createdView) {
                        view = (EditTextClearLinkageView) createdView;
                    }
