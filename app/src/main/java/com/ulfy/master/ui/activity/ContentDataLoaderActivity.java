...
import com.ulfy.master.ui.view.ContentDataLoaderView;


public class ContentDataLoaderActivity extends TitleContentActivity {
    private ContentDataLoaderVM vm;
    private ContentDataLoaderView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(ContentDataLoaderActivity.class);
    }
    ...
    private void initContent(final Bundle savedInstanceState) {
        TaskUtils.loadData(getContext(), vm.loadDataOnExe(), new ContentDataLoader(contentFL, vm, false) {
                    @Override protected void onCreatView(ContentDataLoader loader, View createdView) {
                        view = (ContentDataLoaderView) createdView;
                    }
