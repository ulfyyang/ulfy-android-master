...
public class AppbarBehaviorActivity extends TitleContentActivity {
    private AppbarBehaviorVM vm;
    private AppbarBehaviorView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(AppbarBehaviorActivity.class);
    }
    ...
    private void initContent(final Bundle savedInstanceState) {
        TaskUtils.loadData(getContext(), vm.loadDataOnExe(), new ContentDataLoader(contentFL, vm, false) {
                    @Override protected void onCreatView(ContentDataLoader loader, View createdView) {
                        view = (AppbarBehaviorView) createdView;
                    }
    ...
    private void initActivity(Bundle savedInstanceState) {
        titleTV.setText("AppbarLayoutBehavior");
    }
}