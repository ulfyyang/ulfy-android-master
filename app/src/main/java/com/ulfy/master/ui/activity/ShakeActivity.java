...
import com.ulfy.master.ui.view.ShakeView;


public class ShakeActivity extends TitleContentActivity {
    private ShakeVM vm;
    private ShakeView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(ShakeActivity.class);
    }
