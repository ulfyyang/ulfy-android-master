...
import com.ulfy.master.ui.view.TabPagerView;

public class TabPagerActivity extends TitleContentActivity {
    private TabPagerVM vm;
    private TabPagerView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(TabPagerActivity.class);
    }
