...
import com.ulfy.master.ui.view.SystemView;


public class SystemActivity extends TitleContentActivity {
    private SystemVM vm;
    ...
    public static void startActivity() {
        ActivityUtils.startActivity(SystemActivity.class);
    }
