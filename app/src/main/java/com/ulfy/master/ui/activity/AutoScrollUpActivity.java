...
import com.ulfy.master.ui.view.AutoScrollUpView;


public class AutoScrollUpActivity extends TitleContentActivity {
    private AutoScrollUpVM vm;
    private AutoScrollUpView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(AutoScrollUpActivity.class);
    }
    ...
    private void initContent(final Bundle savedInstanceState) {
        TaskUtils.loadData(getContext(), vm.loadDataOnExe(), new ContentDataLoader(contentFL, vm, false) {
                    @Override protected void onCreatView(ContentDataLoader loader, View createdView) {
                        view = (AutoScrollUpView) createdView;
                    }
