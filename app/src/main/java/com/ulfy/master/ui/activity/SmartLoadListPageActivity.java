...
public class SmartLoadListPageActivity extends TitleContentActivity {
    private SmartLoadListPageVM vm;
    private SmartLoadListPageView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(SmartLoadListPageActivity.class);
    }
    ...
    private void initContent(final Bundle savedInstanceState) {
        TaskUtils.loadData(getContext(), vm.dataTaskInfo, vm.loadDataPerPageOnExe(), new ContentDataLoader(contentFL, vm, false) {
                    @Override protected void onCreatView(ContentDataLoader loader, View createdView) {
                        view = (SmartLoadListPageView) createdView;
                    }
