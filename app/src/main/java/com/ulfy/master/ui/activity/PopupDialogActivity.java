...
import com.ulfy.master.ui.view.PopupDialogView;


public class PopupDialogActivity extends TitleContentActivity {
    private PopupDialogVM vm;
    private PopupDialogView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(PopupDialogActivity.class);
    }
    ...
    private void initContent(final Bundle savedInstanceState) {
        TaskUtils.loadData(getContext(), vm.loadDataOnExe(), new ContentDataLoader(contentFL, vm, false) {
                    @Override protected void onCreateView(ContentDataLoader loader, View createdView) {
                        view = (PopupDialogView) createdView;
                    }
