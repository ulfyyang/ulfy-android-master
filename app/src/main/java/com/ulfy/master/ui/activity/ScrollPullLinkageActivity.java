...
import com.ulfy.master.ui.view.ScrollPullLinkageView;

public class ScrollPullLinkageActivity extends TitleContentActivity {
    private ScrollPullLinkageVM vm;
    private ScrollPullLinkageView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(ScrollPullLinkageActivity.class);
    }
    ...
    private void initContent(final Bundle savedInstanceState) {
        TaskUtils.loadData(getContext(), vm.loadDataOnExe(), new ContentDataLoader(contentFL, vm, false) {
                    @Override protected void onCreateView(ContentDataLoader loader, View createdView) {
                        view = (ScrollPullLinkageView) createdView;
                    }
