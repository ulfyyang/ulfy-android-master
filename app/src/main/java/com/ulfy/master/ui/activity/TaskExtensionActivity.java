...
import com.ulfy.master.ui.view.TaskExtensionView;


public class TaskExtensionActivity extends TitleContentActivity {
    private TaskExtensionVM vm;
    private TaskExtensionView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(TaskExtensionActivity.class);
    }
    ...
    private void initContent(final Bundle savedInstanceState) {
        TaskUtils.loadData(getContext(), vm.loadDataOnExe(), new ContentDataLoader(contentFL, vm, false) {
                    @Override protected void onCreateView(ContentDataLoader loader, View createdView) {
                        view = (TaskExtensionView) createdView;
                    }
