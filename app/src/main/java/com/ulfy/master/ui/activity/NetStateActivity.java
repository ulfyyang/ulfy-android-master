...
import com.ulfy.master.ui.view.NetStateView;


public class NetStateActivity extends TitleContentActivity {
    private NetStateVM vm;
    private NetStateView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(NetStateActivity.class);
    }
