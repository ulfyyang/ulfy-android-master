...
import com.ulfy.master.ui.view.Time1View;


public class Time1Activity extends TitleContentActivity {
    private Time1VM vm;
    private Time1View view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(Time1Activity.class);
    }
