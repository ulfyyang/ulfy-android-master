...
import com.ulfy.master.ui.view.ViewsView;


public class ViewsActivity extends TitleContentActivity {
    private ViewsVM vm;
    private ViewsView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(ViewsActivity.class);
    }
