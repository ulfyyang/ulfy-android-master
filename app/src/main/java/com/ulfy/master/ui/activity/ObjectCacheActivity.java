...
import com.ulfy.master.ui.view.ObjectCacheView;


public class ObjectCacheActivity extends TitleContentActivity {
    private ObjectCacheVM vm;
    private ObjectCacheView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(ObjectCacheActivity.class);
    }
    ...
    private void initContent(final Bundle savedInstanceState) {
        TaskUtils.loadData(getContext(), vm.loadDataOnExe(), new ContentDataLoader(contentFL, vm, false) {
                    @Override protected void onCreatView(ContentDataLoader loader, View createdView) {
                        view = (ObjectCacheView) createdView;
                    }
