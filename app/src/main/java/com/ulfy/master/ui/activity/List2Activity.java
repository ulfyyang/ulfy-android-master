...
public class List2Activity extends TitleContentActivity {
    private List2VM vm;
    private List2View view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(List2Activity.class);
    }
