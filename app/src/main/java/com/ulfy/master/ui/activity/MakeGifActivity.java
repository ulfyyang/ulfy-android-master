...
import com.ulfy.master.ui.view.MakeGifView;


public class MakeGifActivity extends TitleContentActivity {
    private MakeGifVM vm;
    private MakeGifView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(MakeGifActivity.class);
    }
