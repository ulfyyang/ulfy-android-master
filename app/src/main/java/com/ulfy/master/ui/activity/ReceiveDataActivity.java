...
import com.ulfy.master.ui.view.ReceiveDataView;


public class ReceiveDataActivity extends TitleContentActivity {
    private ReceiveDataVM vm;
    private ReceiveDataView view;

    /**
     * 启动Activity
     */
    public static void startActivity(int requestCode) {
        ActivityUtils.startActivity(ReceiveDataActivity.class, requestCode, null);
    }
    ...
    private void initContent(final Bundle savedInstanceState) {
        TaskUtils.loadData(getContext(), vm.loadDataOnExe(), new ContentDataLoader(contentFL, vm, false) {
                    @Override protected void onCreateView(ContentDataLoader loader, View createdView) {
                        view = (ReceiveDataView) createdView;
                    }
