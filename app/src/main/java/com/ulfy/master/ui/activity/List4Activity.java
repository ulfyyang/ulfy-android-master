...
public class List4Activity extends TitleContentActivity {
    private List4VM vm;
    private List4View view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(List4Activity.class);
    }
