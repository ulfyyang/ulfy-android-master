...
import com.ulfy.master.ui.view.BackgrounderView;


public class BackgrounderActivity extends TitleContentActivity {
    private BackgrounderVM vm;
    private BackgrounderView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(BackgrounderActivity.class);
    }
    ...
    private void initContent(final Bundle savedInstanceState) {
        TaskUtils.loadData(getContext(), vm.loadDataOnExe(), new ContentDataLoader(contentFL, vm, false) {
                    @Override protected void onCreatView(ContentDataLoader loader, View createdView) {
                        view = (BackgrounderView) createdView;
                    }
