...
import com.ulfy.master.ui.view.Time2View;

public class Time2Activity extends TitleContentActivity {
    private Time2VM vm;
    private Time2View view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(Time2Activity.class);
    }
