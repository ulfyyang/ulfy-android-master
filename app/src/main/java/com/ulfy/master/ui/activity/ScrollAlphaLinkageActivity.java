...
import com.ulfy.master.ui.view.ScrollAlphaLinkageView;


public class ScrollAlphaLinkageActivity extends TitleContentActivity {
    private ScrollAlphaLinkageVM vm;
    private ScrollAlphaLinkageView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(ScrollAlphaLinkageActivity.class);
    }
    ...
    private void initContent(final Bundle savedInstanceState) {
        TaskUtils.loadData(getContext(), vm.loadDataOnExe(), new ContentDataLoader(contentFL, vm, false) {
                    @Override protected void onCreatView(ContentDataLoader loader, View createdView) {
                        view = (ScrollAlphaLinkageView) createdView;
                    }
