...
import com.ulfy.master.ui.view.DialogLayoutView;

public class DialogLayoutActivity extends TitleContentActivity {
    private DialogLayoutVM vm;
    private DialogLayoutView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(DialogLayoutActivity.class);
    }
    ...
    private void initContent(final Bundle savedInstanceState) {
        TaskUtils.loadData(getContext(), vm.loadDataOnExe(), new ContentDataLoader(contentFL, vm, false) {
                    @Override protected void onCreateView(ContentDataLoader loader, View createdView) {
                        view = (DialogLayoutView) createdView;
                    }
