...
import com.ulfy.master.ui.view.CircleProgressView;

public class CircleProgressActivity extends TitleContentActivity {
    ...
    public static void startActivity() {
        ActivityUtils.startActivity(CircleProgressActivity.class);
    }
