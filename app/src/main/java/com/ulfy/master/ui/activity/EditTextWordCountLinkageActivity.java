...
import com.ulfy.master.ui.view.EditTextWordCountLinkageView;


public class EditTextWordCountLinkageActivity extends TitleContentActivity {
    private EditTextWordCountLinkageVM vm;
    private EditTextWordCountLinkageView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(EditTextWordCountLinkageActivity.class);
    }
    ...
    private void initModel(Bundle savedInstanceState) {
        vm = new EditTextWordCountLinkageVM();
    }
    ...
    private void initContent(final Bundle savedInstanceState) {
        TaskUtils.loadData(getContext(), vm.loadDataOnExe(), new ContentDataLoader(contentFL, vm, false) {
                    @Override protected void onCreateView(ContentDataLoader loader, View createdView) {
                        view = (EditTextWordCountLinkageView) createdView;
                    }
