...
import com.ulfy.master.ui.view.UpgradeCheckView;

public class UpgradeCheckActivity extends TitleContentActivity {
    private UpgradeCheckVM vm;
    private UpgradeCheckView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(UpgradeCheckActivity.class);
    }
    ...
    private void initContent(final Bundle savedInstanceState) {
        TaskUtils.loadData(getContext(), vm.loadDataOnExe(), new ContentDataLoader(contentFL, vm, false) {
                    @Override protected void onCreatView(ContentDataLoader loader, View createdView) {
                        view = (UpgradeCheckView) createdView;
                    }
