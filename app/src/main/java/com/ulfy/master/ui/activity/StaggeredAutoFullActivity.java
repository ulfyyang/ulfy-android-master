...
public class StaggeredAutoFullActivity extends TitleContentActivity {
    private StaggeredAutoFullVM vm;
    private StaggeredAutoFullView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(StaggeredAutoFullActivity.class);
    }
