...
import com.ulfy.master.ui.view.PagerFragmentAdapterView;


public class PagerFragmentAdapterActivity extends TitleContentActivity {
    private PagerFragmentAdapterVM vm;
    private PagerFragmentAdapterView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(PagerFragmentAdapterActivity.class);
    }
    ...
    private void initContent(final Bundle savedInstanceState) {
        TaskUtils.loadData(getContext(), vm.loadDataOnExe(), new ContentDataLoader(contentFL, vm, false) {
                    @Override protected void onCreateView(ContentDataLoader loader, View createdView) {
                        view = (PagerFragmentAdapterView) createdView;
                    }
    ...
    private void initActivity(Bundle savedInstanceState) {
        titleTV.setText("PagerFragment适配器");
    }
}