...
import com.ulfy.master.ui.view.NormalDialogView;


public class NormalDialogActivity extends TitleContentActivity {
    private NormalDialogVM vm;
    private NormalDialogView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(NormalDialogActivity.class);
    }
    ...
    private void initContent(final Bundle savedInstanceState) {
        TaskUtils.loadData(getContext(), vm.loadDataOnExe(), new ContentDataLoader(contentFL, vm, false) {
                    @Override protected void onCreatView(ContentDataLoader loader, View createdView) {
                        view = (NormalDialogView) createdView;
                    }
