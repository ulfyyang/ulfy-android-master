...
import com.ulfy.master.ui.view.DashLineView;


public class DashLineActivity extends TitleContentActivity {
    private DashLineVM vm;
    private DashLineView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(DashLineActivity.class);
    }
