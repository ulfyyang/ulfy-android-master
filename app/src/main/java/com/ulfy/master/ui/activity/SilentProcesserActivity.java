...
import com.ulfy.master.ui.view.SilentProcesserView;


public class SilentProcesserActivity extends TitleContentActivity {
    private SilentProcesserVM vm;
    private SilentProcesserView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(SilentProcesserActivity.class);
    }
    ...
    private void initContent(final Bundle savedInstanceState) {
        TaskUtils.loadData(getContext(), vm.loadDataOnExe(), new ContentDataLoader(contentFL, vm, false) {
                    @Override protected void onCreatView(ContentDataLoader loader, View createdView) {
                        view = (SilentProcesserView) createdView;
                    }
