...
@Layout(id = R.layout.cell_list3)
public class List3Cell extends BaseCell {
    @ViewById(id = R.id.contentTV) private TextView contentTV;
    private List3CM cm;

    public List3Cell(Context context) {
        super(context);
        init(context, null);
    }

    public List3Cell(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
