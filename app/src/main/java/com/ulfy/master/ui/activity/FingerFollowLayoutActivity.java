...
import com.ulfy.master.ui.view.FingerFollowLayoutView;


public class FingerFollowLayoutActivity extends TitleContentActivity {
    private FingerFollowLayoutVM vm;
    private FingerFollowLayoutView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(FingerFollowLayoutActivity.class);
    }
    ...
    private void initContent(final Bundle savedInstanceState) {
        TaskUtils.loadData(getContext(), vm.loadDataOnExe(), new ContentDataLoader(contentFL, vm, false) {
                    @Override protected void onCreatView(ContentDataLoader loader, View createdView) {
                        view = (FingerFollowLayoutView) createdView;
                    }
