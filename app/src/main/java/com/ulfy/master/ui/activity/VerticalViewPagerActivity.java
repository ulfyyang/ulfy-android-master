...
import com.ulfy.master.ui.view.VerticalViewPagerView;


public class VerticalViewPagerActivity extends TitleContentActivity {
    private VerticalViewPagerVM vm;
    private VerticalViewPagerView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(VerticalViewPagerActivity.class);
    }
    ...
    private void initContent(final Bundle savedInstanceState) {
        TaskUtils.loadData(getContext(), vm.loadDataOnExe(), new ContentDataLoader(contentFL, vm, false) {
                    @Override protected void onCreateView(ContentDataLoader loader, View createdView) {
                        view = (VerticalViewPagerView) createdView;
                    }
