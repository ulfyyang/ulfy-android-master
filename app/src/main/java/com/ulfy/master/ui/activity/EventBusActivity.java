...
import com.ulfy.master.ui.view.EventBusView;


public class EventBusActivity extends TitleContentActivity {
    private EventBusVM vm;
    private EventBusView view;

    /**
     * 启动Activity
     */
    public static void startActivity() {
        ActivityUtils.startActivity(EventBusActivity.class);
    }
